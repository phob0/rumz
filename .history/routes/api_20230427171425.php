    ...
    Route::group(['prefix' => 'rum', 'as' => 'rums'], function() {
        ...
        Route::group(['prefix' => 'member', 'as' => 'members'], function() {
            ...
            Route::group(['prefix' => 'invite', 'as' => 'invites'], function() {
                ...
                Route::patch('accept/{rum}', [RumController::class, 'acceptInviteMember'])->name('acceptInviteMemberRum');
            });
...
//    dd($response);
    ...
    //                ->whereHas('isFriends', fn($query) => $query->where('user_id', '00e9a6bf-4ad4-4fe6-b0ea-ff95718458af'))
    //                ->orWhereHas('hasFriends', fn($query) => $query->where('friend_id', '00e9a6bf-4ad4-4fe6-b0ea-ff95718458af'));
    //      })->search('example')->pluck('searchable');
